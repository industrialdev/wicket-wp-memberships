...
/* harmony export */   fetchMembershipProductCategories: () => (/* binding */ fetchMembershipProductCategories),
 ...
 */
const fetchMembershipProductCategories = () => {
  return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    path: `${_constants__WEBPACK_IMPORTED_MODULE_2__.PLUGIN_API_URL}/membership_product_categories`
  });
};
