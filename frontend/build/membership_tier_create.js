...
/* harmony export */   transferMembership: () => (/* binding */ transferMembership),
...
const transferMembership = ({
  ...
  return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
    path: `${_constants__WEBPACK_IMPORTED_MODULE_2__.PLUGIN_API_URL}/membership/${membership_post_id}/transfer_membership`,
    method: 'POST',
    data: {
      new_owner_uuid
    }
