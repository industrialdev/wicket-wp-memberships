...
export const normalizeGroupConfigPostToForm = (post, languageCodes = []) => {
...
export const buildGroupConfigPayload = (form) => ({
  title: form.name,
  status: "publish",
  ...
  group_config_data: {
    ...
    renewal_form_page_id:
      form.group_config_data.renewal_type === "form_page"
        ? parseInt(form.group_config_data.renewal_form_page_id, 10) || 0
        : 0,
