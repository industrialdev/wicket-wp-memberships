...
const buildColumns = (pageData) => [
  {
    label: __("Membership Bundle Name", "wicket-memberships"),
...
/**
 * MembershipRecordsSection — membership bundle page adapter for
 * the shared MembershipRecordsSection UI component.
 *
 * Defines the column layout for the bundle context, maps the singular bundle
