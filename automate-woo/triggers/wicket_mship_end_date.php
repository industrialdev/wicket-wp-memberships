...
class Wicket_Mship_End_Date extends AutomateWoo\Trigger{
...
/**
	...
	public function init() {
		$this->title = __( 'Membership Reached End Date', 'wicket-memberships' );
	...
	public function register_hooks() {
		add_action( 'wicket_memberships_end_date_reached', array( $this, 'catch_hooks' ) );
	}
