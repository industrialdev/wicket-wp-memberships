...
class Wicket_Mship_Grace_Period extends AutomateWoo\Trigger{
...
/**
	...
	public function init() {
		$this->title = __( 'Membership Grace Period Expired', 'wicket-memberships' );
	...
	public function register_hooks() {
		add_action( 'wicket_memberships_grace_period_expired', array( $this, 'catch_hooks' ) );
	}
