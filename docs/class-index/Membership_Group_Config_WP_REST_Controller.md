...
# Membership_Group_Config_WP_REST_Controller Class Index

**File:** includes/Membership_Group_Config_WP_REST_Controller.php
...
**register_routes()**
Registers custom REST API routes for Membership Group Config operations that are not covered by the standard WP REST API.
