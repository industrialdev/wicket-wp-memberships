...
class Settings {
  ...
  public static function wicket_membership_register_settings() {
    ...
    add_settings_field( 'wicket_memberships_debug_acc', '<p>WICKET_MEMBERSHIPS_DEBUG_ACC</p>'.'<p style="font-weight:400">Show membership renewals debug info in account center and allow adjusting days in url (?wicket_wp_membership_debug_days=###) for displaying the renewal callout.</p>', [__NAMESPACE__.'\\Settings', 'wicket_memberships_debug_acc'], 'wicket_membership_plugin', 'debug_settings' );
