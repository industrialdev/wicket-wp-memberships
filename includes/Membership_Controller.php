...
function add_order_item_meta ( $item_id, $values ) {
  ...
  public function get_membership_callouts( $user_id = null ) {
    ...
    foreach( $memberships as &$membership) {
      ...
      // processing one membership (e.g. a pending_approval callout's 'email' key, or
      // an autopay flag from a previous subscription) bleed into the next iteration and
      // produce malformed callouts or incorrectly suppress renewal prompts.
      $callout = [];
